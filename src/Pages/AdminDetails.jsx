                                                                ...
                                                                <form>
                                                                    ...
                                                                    <div className='row'>
                                                                        <div className="col-md-4 mb-3">
                                                                            ...
                                                                            >
                                                                                <option value="1" selected={role_id == 1 ? true : false}>Admin</option>
                                                                                <option value="2" selected={role_id == 2 ? true : false}>Sales</option>
                                                                                <option value="3" selected={role_id == 3 ? true : false}>Management</option>
                                                                                <option value="4" selected={role_id == 4 ? true : false}>Finance</option>
                                                                            </select>
                                                                        ...
                                                                        <div className="col-md-4 mb-3">
                                                                            <label htmlFor="first_name" className="form-label">{t('First Name')} </label>
                                                                            <input disabled={true} type="text" name="first_name" className="form-control" {...register("firstname", { required: true })}
                                                                                defaultValue={first_name || ""}
                                                                                onChange={onFirstNameChange}
                                                                            />
                                                                            <span className='error-text'>
                                                                                {errors.firstname?.type === "required" && t("First name is required")}
                                                                            </span>
                                                                        </div>

                                                                        <div className="col-md-4 mb-3">
                                                                            <label htmlFor="last_name" className="form-label">{t('Last Name')} </label>
                                                                            <input disabled={true} type="text" name="last_name" className="form-control" {...register("lastname", { required: true })}
                                                                                defaultValue={last_name || ""}
                                                                                onChange={onLastNameChange}
                                                                            />
                                                                            <span className='error-text'>
                                                                                {errors.lastname?.type === "required" && t("Last name is required")}
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="row align-items-center">
                                                                        ...
                                                                        <div className="col-md-4 mb-3">
                                                                            <label htmlFor="secondary_contact" className="form-label">{t('Secondary Contact No. (Optional)')} </label>
                                                                            <input disabled={true} type="text" name="secondary_contact" className="form-control" maxLength={10} {...register("secondary_contact", { minLength: 10 })} defaultValue={secondary_contact || ""} />
                                                                            <span className='error-text'>
                                                                                {errors.secondary_contact?.type === "minLength" && t("Phone number is incorrect")}
                                                                            </span>
                                                                        </div>
                                                                        ...
                                                                        <div className="col-md-4 mb-3">
                                                                            <label htmlFor="pin_no" className="form-label">{t('Pin No.')}</label>
                                                                            <input disabled={true} type="text" name="pin_no" className="form-control" maxLength={6} {...register("pin_no", { minLength: 6 })} onChange={(e) => onPincodeChange(e.target.value)} defaultValue={pin_no || ""} />
                                                                            <span className='error-text'>
                                                                                {errors.pin_no?.type === "minLength" && t("Pin number is incorrect")}
                                                                                {error && <div className="error-message">{error}</div>}
                                                                            </span>
                                                                    ...
                                                                    <div className="row">
                                                                        <div className="col-md-4 mb-3">
                                                                            <label htmlFor="address1" className="form-label">{t('Address Line 1')}</label>
                                                                            <input disabled={true} type="text" name="address1" className="form-control" {...register("address1")} defaultValue={address1 || ""} />
                                                                        </div>

                                                                        <div className="col-md-4 mb-3">
                                                                            <label htmlFor="address2" className="form-label">{t('Address Line 2')}</label>
                                                                            <input disabled={true} type="text" name="address2" className="form-control" {...register("address2")} defaultValue={address2 || ""} />
                                                                        </div>
                                                                    ...
                                                                    <div className="row">
                                                                        <div className="col-md-4 mb-3">
                                                                            <label htmlFor="city_name" className="form-label">{t('City Name')}</label>
                                                                            <select disabled={true} name="city" className="form-select" defaultValue={selectedCityName || ""} onChange={(e) => setCityName(e.target.value)} >
                                                                                <option value="" disabled={true}>Select city</option>
                                                                                {cityList.map((city) => (
                                                                                    <option key={city} value={city} selected={selectedCityName === city ? true : ''}> {city} </option>
                                                                                ))}
