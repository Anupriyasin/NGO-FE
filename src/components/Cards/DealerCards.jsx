          ...
          <div className="col-md-4 mt-1">
            <div className="card card2">
              <div className="card-body hello2">
                <h3 className="card-title text-white">{t('Credit Limit')}</h3>
                <motion.div>
                  <div className="radialBar">
                    <span><FaCreditCard className="icon mt-2 text-white" size={20} /></span>
                    <span className="text-white larger-text">₹{row.credit_limit}</span>
                  </div>
                  <div className="detail">
                    <span className="text-white smaller-text">{t('Total credit')}</span>
                  </div>
                </motion.div>
              </div>
            </div>
              ...
              <div className="card-body hello3">
                ...
                <motion.div>
                  <div className="radialBar">
                    ...
                    <span className="text-white larger-text">₹{row.outstanding}</span>
                  </div>
                  <div className="detail">
